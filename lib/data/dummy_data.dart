...
class DummyData {
  static final List<Book> books = [
    ...
    Book(
      ...
      rating: 4.7,
      category: 'Technology',
      description: 'Tìm hiểu về cuộc cách mạng công nghệ lớn nhất thế kỷ 21: Trí tuệ nhân tạo (AI). Làm thế nào học sâu (Deep Learning) và các mô hình ngôn ngữ lớn đang định hình lại công việc, giáo dục và tương lai xã hội loài người.',
      chapters: [
        Chapter(
          id: 'b2_c1',
    ...
    Book(
      ...
      rating: 4.8,
      category: 'Fantasy',
      description: 'Một cuộc phiêu lưu giả tưởng ly kỳ đưa độc giả vào thế giới của ma thuật cổ xưa, các ký tự rune bị lãng quên và một lời nguyền ngàn năm đe dọa hủy diệt vương quốc Eldoria.',
      chapters: [
        Chapter(
          id: 'b4_c1',
          title: 'Chương 1: Ký tự Rune cuối cùng',
          content: 'Màn đêm buông xuống thung lũng sương mù Eldoria, mang theo cái lạnh thấu xương của mùa đông vĩnh cửu. Trong căn phòng nghiên cứu chật hẹp chứa đầy những cuốn sách da dê cũ kỹ, nhà khảo cổ trẻ Alan đang tỉ mỉ quét lớp bụi thời gian khỏi một phiến đá cổ. Dưới ánh nến bập bùng, những đường rãnh ngoằn ngoèo bắt đầu phát sáng một màu xanh lam huyền ảo. Đó là ký tự Rune của sự hủy diệt, thứ ma thuật được cho là đã biến mất cùng sự sụp đổ của các Thượng cổ thần từ ba ngàn năm trước. Một tiếng thì thầm khẽ vang lên bên tai Alan, thôi thúc anh chạm tay vào phiến đá, mở đầu cho chuỗi sự kiện thay đổi hoàn toàn vận mệnh của thế giới.',
        ),
        Chapter(
          id: 'b4_c2',
          title: 'Chương 2: Cánh cổng bóng tối hé mở',
          content: 'Khi ngón tay Alan vừa chạm vào phiến đá, mặt đất đột ngột rung chuyển dữ dội. Một luồng ánh sáng tối đen như mực phóng thẳng lên bầu trời, xé toạc các tầng mây và tạo ra một vết nứt không gian khổng lồ. Từ trong vết nứt, những sinh vật bóng đêm gầm rú lao ra, mang theo nỗi sợ hãi tột cùng gieo rắc lên vương quốc. Alan nhận ra mình vừa vô tình phá vỡ phong ấn của Lời nguyền cổ đại. Để sửa chữa sai lầm, anh phải tìm đến Đền thờ ánh sáng nằm sâu trên đỉnh núi tuyết băng giá, nơi cất giữ bảo vật duy nhất có thể khôi phục lại phong ấn trước khi bóng tối nuốt chửng hoàn toàn Eldoria.',
        ),
      ],
    ),
    Book(
